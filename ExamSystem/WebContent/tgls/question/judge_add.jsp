...
<head>
	...
	<body>
		<div class="cBody">
			<form id="addSchoose" class="layui-form" action="${pageContext.request.contextPath}/addJudge">
			<input type="hidden" name="judge" value="addJudge">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="radio" name="answer" value="0" title="X">
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
