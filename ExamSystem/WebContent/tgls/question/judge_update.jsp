...
<head>
	...
	<%} %>
	<form action="judge_update.jsp" id="passForm" method="post"><input id = "id" type = "hidden" name="id"> </form>
	
	<jsp:useBean id="judgedal" class="com.dal.judgeDal"></jsp:useBean>
	
		<div class="cBody">
			<form id="updateJudge" class="layui-form" action="${pageContext.request.contextPath}/updateJudge">
			...
			%>
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						...
						<textarea id="questionText" name="questionText" placeholder="50字以内" required class="layui-textarea" ><%=judge.getQuestionText() %></textarea>
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">分值</label>
					<div class="layui-input-inline shortInput">
						<input type="text" name="score" id="score" required autocomplete="off" class="layui-input" value="<%=judge.getScore()%>">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="answer" id="score" required autocomplete="off" class="layui-input" value="<%=judge.getAnswer() %>">
					</div>
					<i class="iconfont icon-huaban bt"></i>
				</div>
